...
def get_dashboard(fecha: Optional[str] = None):
    ...
    """
    j  = safe_query(sql_juegos,   (fecha_filtro,), "dashboard.juegos")
    cr = safe_query(sql_crudas,   (fecha_filtro,), "dashboard.crudas")
    dc = safe_query(sql_decomisos,(fecha_filtro,), "dashboard.decomisos")
    pt = safe_query(sql_por_tipo, (fecha_filtro,), "dashboard.por_tipo")
    cv = safe_query(sql_cavas,    (fecha_filtro,), "dashboard.cavas")
...
def get_cruce_diario(
    ...
    rows_cava     = safe_query(sql_cava,     (fecha_filtro, turno_filtro, turno_filtro), "cruce.cava")
    rows_decomiso = safe_query(sql_decomiso, (fecha_filtro, dias_decomisos, fecha_filtro), "cruce.decomiso")
    rows_salidas  = safe_query(sql_salidas,  (fecha_filtro,), "cruce.salidas")
